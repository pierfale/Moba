...
namespace graphics {
	...
	void CharacterInfo::load() {
		...
		magicalAttack->setCoord(util::CoordInt(10, 70));
		...
		physicalArmor->setCoord(util::CoordInt(10, 100));
		...
		magicalArmor->setCoord(util::CoordInt(10, 130));
		...
		attackSpeed->setCoord(util::CoordInt(10, 160));
		...
		speed->setCoord(util::CoordInt(10, 190));
