...
namespace graphics {
	...
	BasicStyle::BasicStyle() :  m_font(sf::Font()), m_fontSize(20), m_fontColor(sf::Color::Black) {
		if(!m_font.loadFromFile("ressources/font/roboto/Roboto-Regular.ttf")) {
			log_err "Unable to load font" end_log_err;
		}
		m_borderImage = NULL;
		m_centerImage = NULL;
	}
